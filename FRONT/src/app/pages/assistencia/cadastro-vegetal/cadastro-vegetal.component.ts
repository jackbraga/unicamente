...
import { Mariri } from './cadastro-vegetal.model';
import { CadastroVegetalService } from './cadastro-vegetal.service';
...
@Component({
  selector: 'app-cadastro-vegetal',
  templateUrl: './cadastro-vegetal.component.html',
  styleUrls: ['./cadastro-vegetal.component.scss'],
  encapsulation: ViewEncapsulation.None,
  providers: [ CadastroVegetalService, MenuService ]
})
export class CadastroVegetalComponent implements OnInit {
  ...
  constructor(public fb:UntypedFormBuilder,
              ...
              public cadastroVegetalService:CadastroVegetalService,
...
removeImage():void{
  ...
  public getMariri(): void {
    this.cadastroVegetalService.getMariri().subscribe( mariris =>
      this.mariris = mariris
    );
  }

  public addMariri(mariri:Mariri){
    this.cadastroVegetalService.addMariri(mariri).subscribe(mariri => {
      this.getMariri();
    });
  }
  ...
  public updateMariri(mariri:Mariri){
    this.cadastroVegetalService.updateMariri(mariri).subscribe(mariri => {
      this.getMariri();
    });
  }
  ...
  public deleteMariri(mariri:Mariri){
    this.cadastroVegetalService.deleteMariri(mariri.id).subscribe(result =>
      this.getMariri()
    );
  }
