...
export const verticalMenuItems = [
   ...
   new Menu (4, 'Buttons', '/ui/buttons', null, 'keyboard-o', null, false, 3),
    ...
    new Menu (4, 'ADMIN_NAV.ASSISTENCIA', null, null, 'universal-access', null, true, 0),

    new Menu (5, 'Vegetal', null, null, 'leaf', null, true, 4),
    new Menu (6, 'Movimento Entrada/Saida', null, null, 'leaf', null, false, 5),
    new Menu (7, 'Cadastro Geral', null, null, 'leaf', null, true, 5),
    new Menu (8, 'Mariri', '/mariri', null, 'leaf', null, false, 7),
    new Menu (9, 'Chacrona', '/chacrona', null, 'leaf', null, false, 7),
    new Menu (10, 'Recipiente', null, null, 'leaf', null, false, 7),
    new Menu (11, 'Sessões', null, null, 'users', null, true, 4),
