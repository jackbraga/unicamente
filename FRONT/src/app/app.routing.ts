...
export const routes: Routes = [
  {
    ...
    children:[
      ...
      // { path: 'mariri', loadChildren: () => import('./pages/mariri/mariri.module').then(m => m.MaririModule), data: { breadcrumb: 'Mariri' } },
      { path: 'mariri', loadChildren: () => import('./pages/assistencia/vegetal/cadastro-geral/mariri/mariri.module').then(m => m.MaririModule), data: { breadcrumb: 'Mariri' } },
      { path: 'chacrona', loadChildren: () => import('./pages/assistencia/vegetal/cadastro-geral/chacrona/chacrona.module').then(m => m.ChacronaModule), data: { breadcrumb: 'Chacrona' } },
